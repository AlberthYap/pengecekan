...
<form action="<?= base_url('admin/editdatauser') ?>" method="post" enctype="multipart/form-data" id="editdata">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer bg-whitesmoke">
					<input name="unit_id" class="unit" hidden>
